...
public class ShootEnemy extends GameObject
{
    ...
    public ShootEnemy(float x, float y, ID id, Handler handler,boolean direction)
    {
        ...
        else imageURL="res/YellowEnemyL.png";
    ...
    public void tick()
    {
        ...
        if(timer<=0){
            handler.addObject(new MiniBullet(x, y, ID.BasicEnemy, handler,direction));
            timer=75;
        }
        else timer--;
        ...
        else handler.addObject(new Trail(image, 36, 36, (float) 0.08, x, y, ID.BasicTrail, handler,"res/YellowEnemyL.png"));

...
public class Boss5 extends GameObject
{
    ...
    public Boss5(float x, float y, ID id, Handler handler)
    {
    ...
    public void tick()
    {
        ...
        velX=((float)((-3.4/distance)*diffX));
        velY=((float)((-3.4/distance)*diffY));
        ...
        if (timer<=0)
        {
           ...
           if (x<=0 || x>=Game.WIDTH-55) velX*=-1; 
            ...
            handler.addObject(new PoisonTrail(image, 40, 40, (float) 0.004, x, y, ID.PoisonTrail, handler));
    }
}
